...
#		endif
		...
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR vec() GLM_DEFAULT;
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR vec(vec<4, T, Q> const& v) GLM_DEFAULT;
...
#		endif//GLM_CONFIG_SWIZZLE == GLM_SWIZZLE_OPERATOR
		...
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR vec<4, T, Q>& operator=(vec<4, T, Q> const& v) GLM_DEFAULT;
