...
namespace glm
{
	...
	struct tdualquat
	{
		...
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR tdualquat() GLM_DEFAULT;
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR tdualquat(tdualquat<T, Q> const& d) GLM_DEFAULT;
		...
		GLM_DEFAULT_FUNC_DECL tdualquat<T, Q> & operator=(tdualquat<T, Q> const& m) GLM_DEFAULT;
