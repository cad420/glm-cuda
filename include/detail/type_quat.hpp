...
#		endif
		...
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR qua() GLM_DEFAULT;
		GLM_DEFAULT_FUNC_DECL GLM_CONSTEXPR qua(qua<T, Q> const& q) GLM_DEFAULT;
...
#		endif
		...
		GLM_DEFAULT_FUNC_DECL qua<T, Q>& operator=(qua<T, Q> const& q) GLM_DEFAULT;
